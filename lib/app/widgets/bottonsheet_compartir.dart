                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (email.isNotEmpty) {
                      ...
                      } else if (await fireStoreService.isUidCreador(idLista, uid)) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('No puedes compartir la lista contigo mismo')),
                        );
                        return;
                      } else {
                        await fireStoreService.updateListadoCompartidosAdd(idLista, uid);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Lista compartida con $email')),
                        );
